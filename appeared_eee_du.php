    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="7" align="center" style="padding-top:50px">
                <u style="font-size:24px"><strong>To Whom It May Concern</strong></u>
            </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: justify; padding-top: 30px; font-size: 20px; line-height: 1.8;">
                <p style="margin-bottom: 15px;">
                    ...
                    Registration No: <strong>' . htmlspecialchars($reg_no) . '</strong>, Session: <strong>' . htmlspecialchars($session) . '</strong>, completed 4 (four) years (8 semesters) academic program and appeared the 4<sup>th</sup> Year 2<sup>nd</sup> Semester (8<sup>th</sup> Semester) final 
                    examination 2023 of the department of Electrical and Electronic Engineering (EEE) of Barishal Engineering College under the University of Dhaka, held from 03 July, 2025 to 21 August, 2025. 
                    ' . $gender_text1 . ' obtained CGPA  <strong>' . $student['CGPA'] . '</strong> out of 4.00 up to 4<sup>th</sup> Year 1<sup>st</sup> Semester (7<sup>th</sup> Semester) of the program.
                    
                    
                </p>
                <p style="font-size: 20px;padding-top:20px">
                    I recommended ' . $gender_text2 . ' candidature for any job/higher education related to B.Sc. Engineering in Electrical and Electronic Engineering (EEE) Degree.
