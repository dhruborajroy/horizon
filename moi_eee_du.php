    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="7" align="center" style="padding-top:50px">
                <u style="font-size:24px"><strong>Certificate of Medium of Instruction</strong></u>
            </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: justify; padding-top: 30px; font-size: 20px; line-height: 1.8;">
                <p style="margin-bottom: 15px;">
                    ...
                    Registration No: <strong>' . htmlspecialchars($reg_no) . '</strong>, Session: <strong>' . htmlspecialchars($session) . '</strong>, completed his 4 (four) years (8 semesters) Bachelor of Science in Electrical and Electronic Engineering from the department of Electrical and Electronic Engineering (EEE) of Barisal Engineering College under the University of Dhaka.
                    
                    
                </p>
                <p style="font-size: 20px;padding-top:20px">
                    It is also certified that the medium of instruction of the University is English and as such ' . strtolower($gender_text1) . ' has been pursuing ' . $gender_text2 . ' studies and examinations in English. ' . $gender_text1 . ' will be able to conduct research or higher study in English.
...
Principal(Additional duty)<br>
Barisal Engineering College<br>
Email: liton.duengg@bec.edu.bd
