...
foreach ($students as $index => $student) {
    ...
    <table width="100%">
        <tr>
            ...
            <span style="font-size:25px; font-family: Siyam Rupali;">ইলেকট্রিক্যাল এন্ড ইলেকট্রনিক ইঞ্জিনিয়ারিং বিভাগ</span><br>
            ...
            <td align="left" colspan="3" style="font-size:20px">
                Department of Electrical and Electronic Engineering<br>Barisal Engineering College<br>Barisal-8200, Bangladesh
            </td>
        </tr>
        <tr><td colspan="7"><hr></td></tr>
        <tr>
            <td align="left" colspan="4">
                <strong>Ref No: BEC/EEE/MOI/' . $batch . '/' . $reg_no . '</strong>
            </td>
