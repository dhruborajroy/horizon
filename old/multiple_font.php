...
// Add text with different alignments including justified, with specified start coordinates
$start_x = 50;
$start_y = 50;

// add_wrapped_text_to_image($image, $text, $font_path_regular, $font_path_bold, $font_size, $text_color, $highlight_color, $highlight_words, $width, 'left', $start_x, $start_y);
// add_wrapped_text_to_image($image, $text, $font_path_regular, $font_path_bold, $font_size, $text_color, $highlight_color, $highlight_words, $width, 'center', $start_x, $start_y + 100);
// add_wrapped_text_to_image($image, $text, $font_path_regular, $font_path_bold, $font_size, $text_color, $highlight_color, $highlight_words, $width, 'right', $start_x, $start_y + 200);
add_wrapped_text_to_image($image, $text, $font_path_regular, $font_path_bold, $font_size, $text_color, $highlight_color, $highlight_words, $width, 'justify', $start_x, $start_y + 300);
...
function add_wrapped_text_to_image($image, $text, $font_path_regular, $font_path_bold, $font_size, $color, $highlight_color, $highlight_words, $image_width, $alignment, $start_x, $start_y) {
    $words = explode(' ', $text);
    $line = '';
